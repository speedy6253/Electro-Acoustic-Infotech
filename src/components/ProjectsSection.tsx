...
export const ProjectsSection: React.FC<ProjectsSectionProps> = ({
  ...
  const displayedProjects = previewOnly ? filteredProjects.slice(0, 6) : filteredProjects;
  ...
  return (
    <section id="projects" className="py-14 sm:py-16 bg-white text-[#0F172A] font-sans border-b border-[#E2E8F0]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        ...
        {previewOnly && (
          <div className="text-center pt-2">
            ...
            >
              <span>View Complete Project Portfolio ({PROJECTS.length}+ Projects)</span>
